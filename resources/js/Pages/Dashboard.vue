...
const data = reactive({
  ...
  claseBotonDashboard: "rounded-t-none sm:rounded-lg px-4 py-6 flex justify-between items-center overflow-hidden",
  VectorBoton: [],
})

props.textoBotones.forEach(function (element, i) {
  data.VectorBoton[i] = data.claseBotonDashboard + " bg-" + coloresBotones[i] + "-600 dark:bg-" + coloresBotones[i] + "-500/80"
      ...
      <div class="mx-auto max-w-screen-2xl pl-4 md:pl-8">
        <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
          ...
          <div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
            <p class="mb-4 font-semibold text-indigo-500 md:mb-6 md:text-lg xl:text-xl">Cambia tu manera de estudiar</p>

            <h1 class="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">Intel-U</h1>
...
<!--    <div class="bg-white py-6 sm:py-8 lg:py-12">-->
<!--      <div class="mx-auto max-w-screen-2xl px-4 md:px-8">-->
<!--        <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Asociados</h2>-->
...
<!--            <svg class="h-6 w-auto sm:h-8 lg:h-10" width="154" height="39" viewBox="0 0 154 39" fill="currentColor"-->
...
<!--          &lt;!&ndash; logo - start &ndash;&gt;-->
<!--          <div class="flex justify-center text-gray-400">-->
<!--            <svg class="h-6 w-auto sm:h-8 lg:h-10" width="186" height="39" viewBox="0 0 186 39" fill="currentColor"-->
<!--                 xmlns="http://www.w3.org/2000/svg">-->
<!--              <path-->
...
<!--          &lt;!&ndash; logo - start &ndash;&gt;-->
<!--          <div class="flex justify-center text-gray-400">-->
<!--            <svg class="h-6 w-auto sm:h-8 lg:h-10" width="173" height="39" viewBox="0 0 173 39" fill="currentColor"-->
<!--                 xmlns="http://www.w3.org/2000/svg">-->
<!--              <path-->
...
<!--          &lt;!&ndash; logo - start &ndash;&gt;-->
<!--          <div class="flex justify-center text-gray-400">-->
<!--            <svg class="h-6 w-auto sm:h-8 lg:h-10" width="146" height="39" viewBox="0 0 146 39" fill="currentColor"-->
<!--                 xmlns="http://www.w3.org/2000/svg">-->
<!--              <path-->
...
<!--    </div>-->
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12">
      <div class="mx-auto max-w-screen-xl px-4 md:px-8">
        <!-- text - start -->
        <div class="mb-10 md:mb-16">
          <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Nuestros resultados</h2>
        ...
        <div class="grid grid-cols-3 gap-8 md:grid-cols-3 md:gap-0 md:divide-x">
          ...
          <div class="flex flex-col items-center md:p-4">
            ...
            <div class="text-sm font-semibold sm:text-base">Lecciones aprendidas</div>
          </div>
          <!-- stat - end -->
...
<!--    <div class="bg-white py-6 sm:py-8 lg:py-12">-->
<!--      <div class="mx-auto max-w-screen-xl px-4 md:px-8">-->
<!--        <h2 class="mb-8 text-center text-2xl font-bold text-gray-800 md:mb-12 lg:text-3xl">Lo que opinan nuestros estudiantes</h2>-->

<!--        <div class="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">-->
<!--          &lt;!&ndash; quote - start &ndash;&gt;-->
...
<!--              <div>-->
<!--                <div class="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">John McCulling-->
<!--                </div>-->
<!--                <p class="text-center text-sm text-gray-500 sm:text-left md:text-sm">CEO / Datadrift</p>-->
<!--              </div>-->
<!--            </div>-->
<!--          </div>-->
<!--          &lt;!&ndash; quote - end &ndash;&gt;-->
...
<!--                     loading="lazy" alt="Photo by christian ferrer" class="h-full w-full object-cover object-center"/>-->
<!--              </div>-->
...
<!--                     loading="lazy" alt="Photo by Ayo Ogunseinde" class="h-full w-full object-cover object-center"/>-->
<!--              </div>-->
...
<!--        <div v-for="(valor,index) in data.VectorBoton">-->
<!--          <div :class=valor>-->
