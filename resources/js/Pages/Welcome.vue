                        ...
                        <div class="ml-12">
                            ...
                            <div v-if="canLogin" class="flex items-center justify-start space-x-4 mt-4">
                                <Link v-if="$page.props.auth.user" :href="route('dashboard')"
                                    class="text-lg text-gray-700 dark:text-gray-500 underline">Tablero principal</Link>

                                <template v-else>
                                    <Link :href="route('login')"
                                        class="text-lg text-gray-700 dark:text-gray-500 underline">{{ lang().label.login }}
                                    </Link>

                                    <Link v-if="canRegister" :href="route('register')"
                                        class="ml-4 text-lg text-gray-700 dark:text-gray-500 underline">{{ lang().label.register }}
                                    </Link>
                                </template>
                            </div>
                        </div>
            ...
            <div class="sm:flex justify-between mt-4 text-sm text-gray-500">
                <div class="flex mx-4 sm:mx-0 flex-row justify-center text-center">
                    <p>
                        ...
                        <a href="https://github.com/zilef2" target="_blank" class="text-primary">Vista previa by Alejandro Madrid</a>
                    </p>
                </div>
