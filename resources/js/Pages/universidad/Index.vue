        ...
        <div class="space-y-4">
            <div class="px-4 sm:px-0">
                <div class="rounded-lg overflow-hidden w-fit">
                    ...
                    <Edit :show="data.editOpen" @close="data.editOpen = false" :universidad="data.generico" :title="props.title" />
                    <Delete :show="data.deleteOpen" @close="data.deleteOpen = false" :universidad="data.generico" :title="props.title" />
                </div>
            </div>
