                                ...
                                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <form @submit.prevent="uploadFileEstudiantes" id="upload">
                                            ...
                                            <progress v-if="form.progress" :value="form.progress.percentage" max="100" class="bg-sky-200">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <form @submit.prevent="uploadEstudiantesUniversidad" id="upload">
                                            <div>
                                                ...
                                                <SelectInput id="universidadID" class="mt-1 block w-full" v-model="form.universidadID" required :dataSet="data.UniversidadSelect"> </SelectInput>
                                            ...
                                            <PrimaryButton v-show="can(['create user'])" :disabled="form.archivo1 == null"
                                                class="rounded-none my-4 mx-4" :class="{ 'bg-gray-200' : form.archivo1 == null}">
                                                {{ lang().button.subir }}
                                            </PrimaryButton>
                                        </form>
