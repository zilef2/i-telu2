        ...
        <div class="container px-5 py-1 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                ...
                <p v-if="data.showText700" class="w-full mx-auto leading-relaxed text-base">
                    Estudiantes de la <b>{{ props.universidad.nombre }}</b> que no pertenecen a <b>{{ props.carrera?.nombre }}</b>
                </p>
            ...
            <div class="flex flex-wrap -m-2">
                <div v-if="props.usuariosPorInscribir.length > 0" v-for="(user, index) in props.usuariosPorInscribir" :key="index" 
