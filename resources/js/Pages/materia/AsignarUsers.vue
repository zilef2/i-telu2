...
const inscribirSubmit = () => {
    form.post(route('materia.SubmitAsignarUsers'), {
        preserveScroll: true,
        onSuccess: () => {
            // emit("close")
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-1 mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Matricular a la materia</h1>
                    <p class="w-full mx-auto leading-relaxed text-base">
                        Estudiantes de <b>{{ props.carrera.nombre }}</b> que no pertenecen a <b>{{ props.materia?.nombre
                        }}</b>
                    </p>
