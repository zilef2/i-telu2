                                        ...
                                        <div v-if="clasegenerica.sub.length" class="flex flex-col">
                                            <div v-for="(subtopicos, Jindex) in clasegenerica.sub" :key="Jindex"
                                                ...
                                                <button
                                                    ...
                                                    for="toggle1" class="underline text-sky-600 ml-2 hover:text-sky-300">
                                                    {{ subtopicos.nombre }}
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                    <div class="p-6">
                                        <p @click="submitToGPT( temaSelectedName, temaSelectedName, ejercicio.nombre )"
                                         ...
                                         class="underline text-sky-300 cursor-help leading-relaxed mb-3">{{ ejercicio.nombre }}.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- <p @click="submitToGPT( temaSelectedName, temaSelectedName, ejercicio.nombre )" -->
        <section v-show="props.respuesta" class="text-gray-600 body-font relative">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full h-full">
                                <div class="relative h-full">
                                    ...
                                    <textarea v-model="form.respuestagpt" id="message" name="message" rows="30" cols="35"
