...
<!--                                                    </div>-->
                                                ...
                                                <div v-if="props.opcion == 2" class="p-2 w-full">
                                                    <div class="relative">
                                                        <label for="pregunta" class="dark:text-white leading-7 text-lg font-bold text-gray-800">
                                                            Resultado de aprendizaje
                                                        </label>
                                                        <p
                                                            class="py-1 px-0 dark:text-white border-t-0 border-x-0 w-full bg-gray-100 bg-opacity-50 rounded  focus:border-indigo-500
