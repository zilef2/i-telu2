<template>
    <transition name="slide-fade">
        <div v-if="flash.success && isVisible" class="fixed top-4 right-4 w-4/6 z-[100]">
    ...
    <transition name="slide-fade">
        <div v-if="flash.error && isErrorVisible" class="fixed top-24 right-4 w-2/3 lg:w-1/2 z-[100]">
