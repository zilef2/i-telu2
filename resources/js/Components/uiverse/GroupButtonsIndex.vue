...
import {  PencilIcon, TrashIcon, UserCircleIcon, ArrowSmallRightIcon } from '@heroicons/vue/24/solid';
...
const emit = defineEmits(["editar","justdelete","irHijo"]);
        ...
        <div class="border border-gray-50 py-3 flex gap-1 shadow-xl">
            ...
            <div v-if="visualizar[0] != ''" 
                ...
                <div class="flex h-10 w-10 items-center justify-center rounded-full hover:text-blue-500">
                    <!-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="32" width="32"> <path stroke="currentColor" d="M9 22V12H15V22M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z"> </path> </svg> -->
            ...
            <div v-if="visualizar[1] != ''" 
                @click="justdelete()"
            class="group relative px-1 cursor-pointer">
                <div class="flex h-10 w-10 items-center justify-center rounded-full hover:text-red-500">
            ...
            <Link v-if="visualizar[2] != ''"  :href="route(ruta, id1)"
                class="group relative px-1 cursor-pointer">
                <div class="flex h-10 w-10 items-center justify-center rounded-full hover:text-blue-500">
