...
class LosPrompsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        LosPromps::create(['principal' => "Cree un plan de lección para una clase de estudiantes de [nivel de habilidad del estudiante] que cubra [tema] e incluya una variedad de actividades y evaluaciones.", 'clasificacion' => 'Expectativas Altas', 'teoricaOpractica' => 'teorica']);
        LosPromps::create(['principal' => "Cree una prueba corta con 5 preguntas de opción múltiple que evalúe la comprensión de los estudiantes sobre [tema]", 'clasificacion' => 'Expectativas Altas', 'teoricaOpractica' => 'practica']);
        LosPromps::create(['principal' => "Crea una tarea que sea desafiante para los estudiantes que tienen una comprensión sólida de [tema], pero que también brinde apoyo y andamiaje a los estudiantes que tienen dificultades con el material.", 'clasificacion' => 'Expectativas Altas', 'teoricaOpractica' => 'teorica']);
        ...
        LosPromps::create(['principal' => "Genere una lista de pasos específicos y accionables que un estudiante puede tomar para mejorar su desempeño en [asignatura].", 'clasificacion' => 'Expectativas Altas', 'teoricaOpractica' => 'teorica']);
        ...
        LosPromps::create(['principal' => "Genere 5 preguntas de opción múltiple que evalúen la comprensión de los estudiantes sobre [el concepto que se enseña].", 'clasificacion' => 'Enseñanza Explicita', 'teoricaOpractica' => 'practica']);
