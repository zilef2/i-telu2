...
<<<<<<< HEAD
        ...
        $promp1 = LosPromps::create(['principal' => "Cree un esquema de lección con intenciones de aprendizaje, actividades creativas y criterios de éxito para una clase sobre [concepto que se enseña].", 'clasificacion' => 'Enseñanza Explicita', 'teoricaOpractica' => 'teorica', 'tokensAproximados' => 1]);
        $promp2 = LosPromps::create(['principal' => "Genere 5 preguntas de opción múltiple que evalúen la comprensión de los estudiantes sobre [el concepto que se enseña].", 'clasificacion' => 'Enseñanza Explicita', 'teoricaOpractica' => 'practica', 'tokensAproximados' => 1]);
        $promp3 = LosPromps::create(['principal' => "Genere un ejemplo de un ensayo bien escrito sobre [tema] que cumpla con los criterios de evaluación para una calificación de 'A' (arriba), con una anotación detallada que explique los criterios de éxito.", 'clasificacion' => 'Enseñanza Explicita', 'teoricaOpractica' => 'teorica', 'tokensAproximados' => 1]);
        $promp4 = LosPromps::create(['principal' => "Genere un glosario de términos y definiciones para una unidad sobre [concepto que se enseña].", 'clasificacion' => 'Enseñanza Explicita', 'teoricaOpractica' => 'teorica', 'tokensAproximados' => 1]);

        $promp0->subtopicos()->attach([ 'subtopico_id' => 1 ]);
        $promp0->users()->attach([ 'user_id' => 1 ]);
        
        $promp1->subtopicos()->attach([ 'subtopico_id' => 1 ]); $promp1->users()->attach([ 'user_id' => 1 ]);
        $promp2->subtopicos()->attach([ 'subtopico_id' => 2 ]); $promp2->users()->attach([ 'user_id' => 2 ]);
        $promp3->subtopicos()->attach([ 'subtopico_id' => 2 ]); $promp3->users()->attach([ 'user_id' => 3 ]);
        $promp4->subtopicos()->attach([ 'subtopico_id' => 2 ]); $promp4->users()->attach([ 'user_id' => 4 ]);
